...
pub(in crate::base) struct TaskStateSegment {
    _reserved0: u32,
...
impl TaskStateSegment {
    ...
    pub(in crate::base) unsafe fn create() -> Self {
        ...
        let stack_bottom = vmm
            .alloc(
                Self::KERNEL_INTERRUPT_STACK_SIZE + 1,
                VmFlags::WRITE,
                AllocationType::AnyPages,
            )
            .unwrap();

        let rsp0 = stack_bottom + Self::KERNEL_INTERRUPT_STACK_SIZE as u64;
